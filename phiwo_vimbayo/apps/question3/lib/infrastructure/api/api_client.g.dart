...
class _ApiClient implements ApiClient {
  ...
  @override
  Future<AllCharacters> getAllCharacter() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<AllCharacters>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = AllCharacters.fromJson(_result.data!);
    return value;
  }
